...
public class ExplotaTuCerebroGUICategorias extends javax.swing.JFrame {
     ...
     * @param nombreUsuario
     */
    public ExplotaTuCerebroGUICategorias(String nombreUsuario, int quesos) {
        if(quesos >= quesosMaximos){
            ExplotaTuCerebroGUIGanador ganador;
            try {
                ganador = new ExplotaTuCerebroGUIGanador(nombreUsuario);
    ...
    private void btnAnatomiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnatomiaActionPerformed
        ...
        ExplotaTuCerebroInterface guiInterface = new ExplotaTuCerebroInterface(categoriaSeleccionada, nombreUsuario);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExplotaTuCerebroGUICategorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ExplotaTuCerebroGUICategorias(null,0).setVisible(true);
            }
        });
    }
