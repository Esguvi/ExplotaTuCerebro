...
public class ExplotaTuCerebroGUI extends javax.swing.JFrame {

    /**
     * Creates new form GUI
     */
    public ExplotaTuCerebroGUI() throws SQLException{
        initComponents();
    ...
    private void btnSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSesionActionPerformed
        ...
        ExplotaTuCerebroGUISesion Sesion;
        try {
            Sesion = new ExplotaTuCerebroGUISesion();
    ...
    private void btnRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistroActionPerformed
        // TODO add your handling code here:
        ExplotaTuCerebroGUIRegistro Registro;
        try {
            Registro = new ExplotaTuCerebroGUIRegistro();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExplotaTuCerebroGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new ExplotaTuCerebroGUI().setVisible(true);
                }
                catch (SQLException ex) {
                    ex.getMessage();
                }
